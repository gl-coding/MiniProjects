...
def sendEmail(to, filename):
	From = "happykindle@yeah.net"  
	To = to  
	file_name = filename#附件名  
	  
	server = smtplib.SMTP("smtp.yeah.net")  
	server.login("happykindle","123qwe$") #仅smtp服务器需要验证时  
...
if __name__ == "__main__":
	...
	to = "cool3stone@qq.com" 
	filename = "d:/test.png"
	sendEmail(to, filename)